...
class Home:
    ...
    def __init__(self):
        ...
        def mount_balance():
            ...
            ticket_revenue_ammount = query_executor.simple_consult_query(query=ticket_revenue_query, params=(user_name, user_document))
            ...
            ticket_expense_ammount = query_executor.simple_consult_query(query=ticket_expense_query, params=(user_name, user_document))
            ...
            fund_revenue_ammount = query_executor.simple_consult_query(query=fund_revenue_query, params=(user_name, user_document))
            ...
            fund_expense_ammount = query_executor.simple_consult_query(query=fund_expense_query, params=(user_name, user_document))
            ...
            loan_ammount = query_executor.simple_consult_query(query=loan_expense_query, params=(user_name, user_document))
            ...
            debts_ammount = query_executor.simple_consult_query(query=debts_expense_query, params=(user_name, user_document))
        ...
        def show_balance():
            ...
            with col4:
                ...
                with st.expander(label=":credit_card: Cartões de crédito", expanded=True):
                    cards_result = query_executor.complex_consult_query(query=owner_active_cards_query, params=(user_name, user_document))
            ...
            with col6:
                ...
                with st.expander(label=":bar_chart: Contas Correntes", expanded=True):
                    accounts_expense_graph = query_executor.complex_consult_query(query=most_categories_expenses_query, params=(user_name, user_document))
                ...
                with st.expander(label=":bar_chart: Cartão de Crédito", expanded=True):
                    credit_card_expense_graph = query_executor.complex_consult_query(query=most_credit_card_expenses_query, params=(user_name, user_document))
                ...
                with st.expander(label=":bar_chart: Contas Correntes", expanded=True):
                    accounts_revenue_graph = query_executor.complex_consult_query(most_categories_revenues_query, params=(user_name, user_document))
