...
class Home:
    ...
    def mount_card_graph(self, selected_card: str):
        ...
        credit_card_data_df["Porcentagem"] = credit_card_data_df[
            "Porcentagem"
    ...
    def main_menu(self):
        ...
        with col2:
            ...
            with col22:
                ...
                if user_sex == "F":
                    st.subheader(
                        body="Bem vind{}, {}!".format("a", str_user_name[0])
                    )
                elif user_sex == "M":
                    st.subheader(
                        body="Bem vind{}, {}!".format("o", str_user_name[0])
                    )
        ...
        with col3:
            ...
            with col33:
                ...
                st.info(
                    body=":mantelpiece_clock: {}".format(app_actual_horary)
                )
        ...
        with col4:
            ...
            with st.expander(
                label=":chart: Valores principais",
                expanded=True
            ):
                st.text(
                ...
                st.text(
                    ...
                    help="""
                    Valor considerando saldo de vales alimentação e refeição.
                    """
                )
                st.info(
                    body="""
                ...
                st.text(
                    ...
                    help="""
                    Dívidas e empréstimos contraídos que ainda não foram pagos.
                    """
                )
                st.info(
                    body="""
        ...
        with col5:
            ...
            with st.expander(
                label=":scroll: Últimos registros",
                expanded=True
            ):
                ...
                if len(last_revenues) > 0:
                    ...
                    st.warning(body="Você ainda não registrou receitas.")
                ...
                if len(last_expenses) > 0:
                    ...
                    st.warning(
                        body="Você ainda não registrou despesas."
                    )

            with st.expander(
                label=":scroll: Maiores registros",
                expanded=True
            ):
                ...
                if len(max_expense) > 0:
                    ...
                    st.warning(
                        body="Você ainda não regitrou despesas."
                    )
        ...
        with col6:
            ...
            with st.expander(
                label=":bar_chart: Contas Correntes",
                expanded=True
            ):
                ...
                if len(accounts_expense_graph) > 0:
                    ...
                    ax.set_title(
                        "Despesas por Categoria - Contas Correntes",
                        fontsize=12,
                    ...
                    st.warning(body="Você ainda não registrou despesas.")

            with st.expander(
                label=":bar_chart: Cartão de Crédito",
                expanded=True
            ):
                ...
                if len(credit_card_expense_graph) > 0:
                    ...
                    ax.set_title(
                        "Despesas por Categoria - Cartão de Crédito",
                        fontsize=14,
                        fontproperties=custom_font
                    )
                    ...
                    st.warning(
                        body="Você ainda não registrou despesas de cartão."
                    )
            ...
            with st.expander(
                ...
                if (account_df["Valor"].sum()) > 0:
                    ...
                    st.warning(
                        body="Você ainda não registrou receitas."
                    )
