...
class NewCurrentExpense:
    """
    Classe responsável pela coleta e cadastro de uma nova despesa em contas correntes.

    Attributes
    ----------
    get_expense()
        Realiza a coleta dos dados da despesa e a insere no banco de dados.
    """
        ...
        if len(user_current_accounts) == 0:
            ...
            with col3:
                ...
                if confirm_values_check_box and generate_receipt_button:
                    ...
                    with data_validation_expander:
                        st.info(
                            body="Valor disponível da conta {}: R$ {}".format(
