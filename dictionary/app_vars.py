...
account_models = QueryExecutor().complex_consult_brute_query(account_models_query)
account_models = QueryExecutor().treat_numerous_simple_result(account_models, to_remove_list)
