...
usando apenas session_state do Streamlit com uma chave especial para persistência.
"""
...
class SimplePersistentAuth:
    ...
    def save_auth_data(self, username: str, access_token: str, refresh_token: str) -> None:
        ...
        try:
            ...
            logger.info(f"Dados de autenticação salvos para usuário {username}")
    ...
    def load_auth_data(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Dados de autenticação carregados para usuário {auth_data.get('username')}")
            return auth_data
    ...
    def restore_session(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Sessão restaurada para usuário {auth_data.get('username')}")
            return True
