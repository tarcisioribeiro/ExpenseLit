...
class Credit_Card:
    """
    Uma classe para realizar consultas e cálculos relacionados ao cartão de cŕedito.

    Methods
    -------
    get_card_month(selected_card)
        Retorna o mês do fechamento atual do cartão.
    not_payed_card_expenses(selected_card)
        Retorna o valor total das despesas não pagas do cartão.
    month_expenses(selected_card, selected_month)
        Retorna o valor das despesas do cartão em um mês selecionado.
    month_complete_expenses(selected_card, selected_month)
        Retorna os detalhes das despesas do cartão em um mês selecionado.
    get_card_id_month_expenses(selected_card, selected_month)
        Retorna a listas dos id's das despesas do cartão em um mês selecionado.
    future_expenses(selected_card)
        Retorna o valor das despesas futuras do cartão.
    card_limit(selected_card)
        Retorna o limite de crédito do cartão selecionado.
    credit_card_key(selected_card)
        Retorna os dados do cartão de crédito.
    card_remaining_limit(selected_card)
        Retorna o limite restante do cartão de crédito.
    """

    def get_card_month(self, selected_card: str):
        """
        Consulta o mês do fechamento onde a data atual se encontra.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para consulta.

        Returns
        -------
        actual_month: str
            O mês atual de fechamento.
        """
    ...
    def not_payed_card_expenses(self, selected_card: str):
        """
        Realiza a busca das despesas não pagas no mês do cartão.
    ...
    def month_expenses(self, selected_card: str, selected_month: str):
        """
        Realiza a consulta do valor das despesas de cartão no mês selecionado.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para a consulta.
        selected_month: str
            Mês selecionado para a consulta.

        Returns
        -------
        value: float
            O valor total das despesas do cartão no mês selecionado.
        """
    ...
    def month_complete_expenses(self, selected_card: str, selected_month: str):
        """
        Realiza a consulta detalhada das despesas de cartão no mês selecionado.
        ...
        -------
        values_tuple: tuple
            A tupla com os detalhes das despesas do cartão no mês selecionado.
        """
    ...
    def get_card_id_month_expenses(self, selected_card: str, selected_month: str):
        """
        Realiza a consulta dos id's das despesas de cartão no mês selecionado.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para busca dos id's.
        selected_month: str
            Mês selecionado para consulta dos id's.

        Returns
        -------
        converted_id_list: list
            A lista dos id's das despesas do cartão.
        """
    ...
    def future_expenses(self, selected_card: str):
        """
        Realiza a consulta do valor das próximas despesas do cartão.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para a consulta dos valores.

        Returns
        -------
        value: float
            O valor total das próximas despesas.
        """
    ...
    def card_limit(self, selected_card: str):
        """
        Realiza a consulta do limite do cartão de crédito.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para a consulta do limite.

        Returns
        -------
        value: float
            O valor do limite de crédito do cartão.
        """
    ...
    def credit_card_key(self, selected_card: str):
        """
        Realiza a consulta dos dados do cartão de crédito.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para a consulta dos dados.

        Returns
        -------
        card_tuple: tuple
            Retorna a tupla com os dados do cartão.
        """
    ...
    def card_remaining_limit(self, selected_card: str):
        """
        Realiza o cáculo do limite restante do cartão.

        Parameters
        ----------
        selected_card: str
            Cartão selecionado para o cálculo.
        ...
        not_payed_expenses = self.not_payed_card_expenses(selected_card)
        month_card_expenses = self.month_expenses(selected_card, string_actual_month)
