...
async def run_tests():
    ...
    async with async_playwright() as p:
        ...
        expense_result = await test_instance.test_expense_edit_functionality(page)
        
        # Teste 3: Edição de receitas
        print("\n3. Testando edição de receitas...")
        revenue_result = await test_instance.test_revenue_edit_functionality(page)
...
if __name__ == "__main__":
    ...
    with open("/home/tarcisio/Development/ExpenseLit/error.txt", "w") as f:
        ...
        if results["expense_edit"] is True:
            ...
            f.write("⚠️ AVISO: Não foi possível testar - nenhuma despesa encontrada\n")
        ...
        if results["revenue_edit"] is True:
            ...
            f.write("⚠️ AVISO: Não foi possível testar - nenhuma receita encontrada\n")
